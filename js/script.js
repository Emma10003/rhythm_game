$(function () {
    ...
    */
    ...
    /*
        ...
        - 아이템생성함수 -> createItems 로 함수명 변경하는 게 좋다
    */
    function 아이템생성함수() {
        // 0 ~ 3 중 랜덤한 레인 선택
        ...
        // 선택된 레인의 가로 너비 계산
        // 0 ~ 3 번 레인 중 .eq(=) 동일한 레인의 가로너비 길이 가져오기
        ...
        item.animate({ top: $("#game-container").height() + "px" }, 2000, "linear", function () {
